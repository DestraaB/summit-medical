        ...
        <div class="card-body">
            ...
            <form action="<?= base_url('services/create'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="name" name="name" required placeholder="Contoh: Poli Gigi & Mulut" value="<?= set_value('name'); ?>">
                </div>

                <div class="form-group mb-3">
                    <label for="icon" class="font-weight-bold">Ikon Layanan <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="icon" name="icon" required placeholder="Contoh: fas fa-tooth" value="<?= set_value('icon'); ?>">
                ...
                <div class="form-group mb-3">
                    <label for="image" class="font-weight-bold">Foto Layanan</label>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="short_description" name="short_description" required placeholder="Deskripsi 1-2 kalimat untuk ditampilkan di kartu halaman depan" value="<?= set_value('short_description'); ?>">
                </div>

                <div class="form-group mb-4">
                    <label for="description" class="font-weight-bold">Deskripsi Lengkap <span class="text-danger">*</span></label>
                    <textarea class="form-control" id="description" name="description" rows="5" required placeholder="Tulis detail lengkap layanan di sini..."><?= set_value('description'); ?></textarea>
                </div>

                <div class="form-group mb-4">
                    <label for="status" class="font-weight-bold">Status <span class="text-danger">*</span></label>
                    <select class="form-control" id="status" name="status" required>
                        <option value="1" <?= set_select('status', '1', TRUE); ?>>Aktif (Tampil di Website)</option>
                        <option value="0" <?= set_select('status', '0'); ?>>Tidak Aktif (Sembunyikan)</option>
                    </select>
                </div>
